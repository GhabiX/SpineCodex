...
function Get-ReleaseAssetMetadata {
    ...
    $release = Invoke-RestMethod -Uri "https://api.github.com/repos/GhabiX/SpineCodex/releases/tags/rust-v$ResolvedVersion"
...
function Resolve-Version {
    ...
    $release = Invoke-RestMethod -Uri "https://api.github.com/repos/GhabiX/SpineCodex/releases/latest"
...
function Maybe-HandleConflictingInstall {
    ...
    $uninstallArgs = if ($manager -eq "bun") {
        @("remove", "-g", "@spinejit/spine-codex")
    } else {
        @("uninstall", "-g", "@spinejit/spine-codex")
    }
