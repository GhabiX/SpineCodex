...
pub(super) fn validate_commit_marker_record(marker: &SpineCommitMarker) -> Result<(), SpineError> {
    validate_commit_marker_version(marker)?;
    validate_commit_marker_op_id(marker)?;
    validate_commit_marker_token_range(marker)?;
    validate_commit_marker_memory_refs_present(marker)?;
    Ok(())
}

fn validate_commit_marker_version(marker: &SpineCommitMarker) -> Result<(), SpineError> {
...
fn validate_commit_marker_op_id(marker: &SpineCommitMarker) -> Result<(), SpineError> {
...
fn validate_commit_marker_token_range(marker: &SpineCommitMarker) -> Result<(), SpineError> {
...
fn validate_commit_marker_memory_refs_present(
