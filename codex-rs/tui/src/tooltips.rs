...
const ANNOUNCEMENT_TIP_URL: &str = codex_install_context::distribution::ANNOUNCEMENT_TIP_URL;

const IS_MACOS: bool = cfg!(target_os = "macos");
const IS_WINDOWS: bool = cfg!(target_os = "windows");

const APP_TOOLTIP: &str = "Try the **Codex App**. Run 'spine-codex app' or visit https://chatgpt.com/codex?app-landing-page=true";
const FAST_TOOLTIP: &str =
    "*New* Use **/fast** to enable our fastest inference with increased plan usage.";
const OTHER_TOOLTIP: &str = "*New* Build faster with the **Codex App**. Run 'spine-codex app' or visit https://chatgpt.com/codex?app-landing-page=true";
