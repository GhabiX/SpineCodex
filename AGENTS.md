...
Commit and push this repo separately, then update the outer submodule pointer
...
compatibility contracts. Record unresolved semantic gaps in the outer
`doc/refactor/ckq-design/refactor-conflict.md`.
